...
class ExplorerSearchInfo extends Component {

    obj = {
        "id": 1,
        "jsonrpc": "2.0",
        "method": "explorer.search",
        "params": {
            "str": "40085", 
            "max_count": 2
        }
        ...
        return (
            <Fragment>
                ...
                <div className="docs-info__description">
                    <p>Возвращает список адресов блока</p>
                </div>
                ...
                <div className="docs-info__example-block">
                    ...
                    <div>
                        <pre>
                            <code>{`[
    {
        "hash": "00000000ba779d5df5917ba98086f4200e33a33b4374c045d44f220b7ba2f821",
        "heihgt": 40085,
        "type": "block"
    }
]`}</code>
...
export default ExplorerSearchInfo;