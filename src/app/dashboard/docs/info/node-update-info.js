...
class NodeUpdateInfo extends Component {
        ...
        return (
            <Fragment>
                ...
                <div className="docs-info__description">
                    <p>Обновляет созданную ноду по идентификатору (в запрос добавляются обновляемые параметры)</p>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Структурированное значение, которое содержит значения параметров, которые будут использоваться во время вызова метода.</td>
                            </tr>
                            <tr>
                                <td><span>id</span></td>
